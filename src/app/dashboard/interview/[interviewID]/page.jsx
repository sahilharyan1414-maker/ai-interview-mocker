                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="border rounded-xl p-6 bg-yellow-50 border-yellow-300">
                        ...
                        <p className="text-sm text-gray-700 leading-6">
                            Enable Video Webcam and Microphone to start your AI
                            generated mock interview. The interview contains 5
                            questions and you will receive feedback based on
                            your answers.

                            <br />
                            <br />

                            <strong>Note:</strong> We never record your video.
                            Webcam access is only used during the interview
                            session and can be disabled anytime.
                        </p>
